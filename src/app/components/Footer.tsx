    ...
    <div className={styles.footer__container}>
      <div className={styles.footer}>
        <ul>
          ...
          <li className={styles.footer__option}>2024 © XpertAI Inc.</li>
        </ul>
        <ul>
          <h1 className={styles.footer__header}>Learn More</h1>
          <li className={styles.footer__option}>Plans</li>
          <li className={styles.footer__option}>XpertAI Military</li>
          <li className={styles.footer__option}>XpertAI Enterprise</li>
          <li className={styles.footer__option}>XpertAI for Healthcare</li>
        ...
        <ul>
          ...
          <li className={styles.footer__option}>Contract Generator</li>
