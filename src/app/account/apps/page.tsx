        ...
        <div className={styles.apps__content}>
          ...
          <div>
            {AppsList.map((app, index) => (
              <div key={index} className={styles.apps__content__container}>
                <div>
                  <h3 className={styles.apps__content__container__title}>
                    {app.title}
                  </h3>
                  <p>{app.desc}</p>
                </div>
                <button className={styles.apps__content__container__btn}>
                  Coming Soon!
                </button>
              </div>
            ))}
