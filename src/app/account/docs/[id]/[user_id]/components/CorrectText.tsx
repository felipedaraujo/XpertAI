...
interface CorrectTextProps {
  text: string
  setMistakeText: React.Dispatch<
    React.SetStateAction<undefined | string | Element>
  >
...
const CorrectText: React.FC<CorrectTextProps> = ({
  text,
  setText,
  setMistakeText,
  mistakeText,
  ...
  return (
    <div className={styles.correct_text__container}>
      <div className={styles.correct_text__container__header}>
        <svg
          className={styles.correct_text__container__header__icon__blue}
      ...
      <div className={styles.correct_text__container__footer}>
        <button
          ...
          onClick={handleCorrectTextDismiss}
        >
          Thank you
        </button>
        <button
